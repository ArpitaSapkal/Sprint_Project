...
function loadStorageSampleData(){
    if(!localStorage.getItem("items")){
        const sampleItems = [{'name':'veg burger',
        'img':'C:\Users\aditya\Desktop\Task5\Images\veg.jpg',
        'description':'Fresh and Yummy Veg Burger'},
        {'name':'chicken burger',
        'img':'C:\Users\aditya\Desktop\Task5\Images\chicken.jpg',
